...
// Initialize Record the start time and initiate tracing before creating records to facilitate subsequent monitoring and analysis of SQL query performance.
