...
const (
	Video_GetVideoList_FullMethodName         = "/service.Video/GetVideoList"
	Video_PublishVideo_FullMethodName         = "/service.Video/PublishVideo"
	Video_UpdateVideo_FullMethodName          = "/service.Video/UpdateVideo"
	Video_GetVideoListByAuthor_FullMethodName = "/service.Video/GetVideoListByAuthor"
	Video_FavoriteVideo_FullMethodName        = "/service.Video/FavoriteVideo"
	Video_UnFavoriteVideo_FullMethodName      = "/service.Video/UnFavoriteVideo"
	Video_GetFavoriteVideoList_FullMethodName = "/service.Video/GetFavoriteVideoList"
	Video_IsFavoriteVideo_FullMethodName      = "/service.Video/IsFavoriteVideo"
	Video_CommentVideo_FullMethodName         = "/service.Video/CommentVideo"
	Video_GetCommentList_FullMethodName       = "/service.Video/GetCommentList"
	Video_DeleteVideoComment_FullMethodName   = "/service.Video/DeleteVideoComment"
	Video_GetCommentInfo_FullMethodName       = "/service.Video/GetCommentInfo"
)
...
func (c *videoClient) GetVideoListByAuthor(ctx context.Context, in *GetVideoListByAuthorRequest, opts ...grpc.CallOption) (*GetVideoListByAuthorResponse, error) {
	...
	err := c.cc.Invoke(ctx, Video_GetVideoListByAuthor_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoClient) FavoriteVideo(ctx context.Context, in *FavoriteVideoRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Video_FavoriteVideo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoClient) UnFavoriteVideo(ctx context.Context, in *UnFavoriteVideoRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Video_UnFavoriteVideo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoClient) GetFavoriteVideoList(ctx context.Context, in *GetFavoriteVideoListRequest, opts ...grpc.CallOption) (*GetFavoriteVideoListResponse, error) {
	...
	err := c.cc.Invoke(ctx, Video_GetFavoriteVideoList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoClient) IsFavoriteVideo(ctx context.Context, in *IsFavoriteVideoRequest, opts ...grpc.CallOption) (*IsFavoriteVideoResponse, error) {
	...
	err := c.cc.Invoke(ctx, Video_IsFavoriteVideo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoClient) CommentVideo(ctx context.Context, in *CommentVideoRequest, opts ...grpc.CallOption) (*CommentVideoResponse, error) {
	...
	err := c.cc.Invoke(ctx, Video_CommentVideo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoClient) GetCommentList(ctx context.Context, in *GetCommentListRequest, opts ...grpc.CallOption) (*GetCommentListResponse, error) {
	...
	err := c.cc.Invoke(ctx, Video_GetCommentList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoClient) DeleteVideoComment(ctx context.Context, in *DeleteVideoCommentRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Video_DeleteVideoComment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoClient) GetCommentInfo(ctx context.Context, in *GetCommentInfoRequest, opts ...grpc.CallOption) (*GetCommentInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, Video_GetCommentInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
